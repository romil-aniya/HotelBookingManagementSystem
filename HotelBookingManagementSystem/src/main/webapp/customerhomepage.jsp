...
<div class="container">
  ...
  <label><b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspCHECK OUT :&nbsp&nbsp&nbsp</label></b></label>
...
<div class='col-sm-3'  style='float:right;background-color: #12331; border-radius:1px;'>
   ...
   <br>
	<form>
    <button class='btn btn-danger btn-block'><a href="MyProfile.html">MY PROFILE</button></a>
<br>
     <button class='btn btn-primary btn-block'><a href="MyBookings.html">MY BOOKINGS</button></a><br>
     <center><button class='btn btn-success'> <a href="home.html">LOGOUT</button></center>
   </form>
</div>
<footer>
